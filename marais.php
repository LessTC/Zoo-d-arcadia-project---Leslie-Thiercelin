...
/**
 * Page publique de l'habitat Marais.
...
$titrePage       = 'Marais — Zoo d’Arcadia';
$descriptionPage = 'Les marais exotiques du Zoo d’Arcadia : présentation des animaux.';
$classeBody      = 'bg-marais';
...
?>
  ...
  <section class="py-4">
    <div class="container">
      <h1 class="text-white mb-3">Les marais exotiques</h1>
      <div class="intro-marais p-3 p-md-4">
